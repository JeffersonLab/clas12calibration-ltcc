...
java -Dsun.java2d.pmoffscreen=false -Xmx2048m -Xms1024m -cp "$CLAS12DIR/lib/clas/*:$CLAS12DIR/lib/services/*:$DISTRO_DIR/lib/LTCCCalib-1.0.jar" org.clas.viewer.CalibrationViewer $*
